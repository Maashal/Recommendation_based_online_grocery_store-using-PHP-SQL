...
<h1 class="text text-capitalize text-center text-primary"style="color: Black">View Offers Panel</h1>
<?php 
  ...
  ?>
      <table align="center" style="margin-top:10px;width:80%;background-color: darkgray" class="table table-striped table-bordered">
          <caption style="border: 1px solid gray;background-color: lightblue"><b>Products Offers</b></caption>
          <tr >
       <th>S.No</th>
       <th>Product Name</th>
       <th>Product Image</th>
